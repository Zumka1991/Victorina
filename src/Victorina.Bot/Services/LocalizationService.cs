...
public static class LocalizationService
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Translations = new()
    {
        ["ru"] = new Dictionary<string, string>
        {
            ...
            ["draw"] = "🤝 Ничья!",
            ["your_result"] = "📊 <b>Ваш результат:</b>",
            ["correct_answers"] = "✅ Правильных: {0}",
            ["time_spent"] = "⏱ Время: {0} сек",
            ["opponent_result"] = "📊 <b>Соперник:</b> {0} {1}",
            ...
            ["friend_search"] = "🔍 Введите @username друга для приглашения (например: @ivan или ivan):",
            ...
            ["game_invite_from"] = "🎮 {0} приглашает вас в игру! Выберите категорию:",
            ["you_in_game"] = "⚠️ У вас уже есть активная игра.",
            ["opponent_in_game"] = "⚠️ Игрок не может сейчас принять ваше предложение, он в данный момент находится в игре.",
            ...
            ["invite_declined"] = "❌ Вы отклонили приглашение.",
            ["invite_was_declined"] = "😔 {0} отклонил(а) ваше приглашение.",
            ["friend_accepted_invite"] = "✅ {0} принял(а) ваше приглашение! Нажмите «Готов» чтобы начать игру.",
        ...
        ["hi"] = new Dictionary<string, string>
        {
            ...
            ["you_lost"] = "😔 आप हारे",
            ["draw"] = "🤝 बराबरी!",
            ["your_result"] = "📊 <b>आपका परिणाम:</b>",
            ["correct_answers"] = "✅ सही: {0}",
            ["time_spent"] = "⏱ समय: {0} सेकंड",
            ["opponent_result"] = "📊 <b>प्रतिद्वंद्वी:</b> {0} {1}",
            ...
            ["friend_search"] = "🔍 दोस्त को आमंत्रित करने के लिए @username दर्ज करें (उदाहरण: @ivan या ivan):",
            ...
            ["opponent_in_game"] = "⚠️ खिलाड़ी अभी आपका प्रस्ताव स्वीकार नहीं कर सकता, वह इस समय खेल में है।",
            ...
            ["category_info"] = "\n📚 श्रेणी: *{0}*",
            ["invite_accepted"] = "✅ आपने निमंत्रण स्वीकार किया!",
            ["invite_declined"] = "❌ आपने निमंत्रण अस्वीकार कर दिया।",
            ["invite_was_declined"] = "😔 {0} ने आपका निमंत्रण अस्वीकार कर दिया।",
            ["friend_accepted_invite"] = "✅ {0} ने आपका निमंत्रण स्वीकार किया! गेम शुरू करने के लिए «तैयार» क्लिक करें।",
        ...
        ["pt"] = new Dictionary<string, string>
        {
            ...
            ["draw"] = "🤝 Empate!",
            ["your_result"] = "📊 <b>Seu resultado:</b>",
            ["correct_answers"] = "✅ Corretas: {0}",
            ["time_spent"] = "⏱ Tempo: {0} seg",
            ["opponent_result"] = "📊 <b>Oponente:</b> {0} {1}",
            ...
            ["friend_search"] = "🔍 Digite o @username do amigo para convidar (exemplo: @ivan ou ivan):",
            ...
            ["opponent_in_game"] = "⚠️ O jogador não pode aceitar seu convite agora, ele está atualmente em um jogo.",
            ...
            ["category_info"] = "\n📚 Categoria: *{0}*",
            ["invite_accepted"] = "✅ Você aceitou o convite!",
            ["invite_declined"] = "❌ Você recusou o convite.",
            ["invite_was_declined"] = "😔 {0} recusou seu convite.",
            ["friend_accepted_invite"] = "✅ {0} aceitou seu convite! Clique em «Pronto» para começar o jogo.",
        ...
        ["fa"] = new Dictionary<string, string>
        {
            ...
            ["you_lost"] = "😔 شما باختید",
            ["draw"] = "🤝 مساوی!",
            ["your_result"] = "📊 <b>نتیجه شما:</b>",
            ["correct_answers"] = "✅ درست: {0}",
            ["time_spent"] = "⏱ زمان: {0} ثانیه",
            ["opponent_result"] = "📊 <b>حریف:</b> {0} {1}",
            ...
            ["friend_search"] = "🔍 @username دوست را برای دعوت وارد کنید (مثال: @ivan یا ivan):",
            ...
            ["opponent_in_game"] = "⚠️ بازیکن نمی‌تواند اکنون دعوت شما را بپذیرد، او در حال حاضر در بازی است.",
            ...
            ["category_info"] = "\n📚 دسته: *{0}*",
            ["invite_accepted"] = "✅ شما دعوت را پذیرفتید!",
            ["invite_declined"] = "❌ شما دعوت را رد کردید.",
            ["invite_was_declined"] = "😔 {0} دعوت شما را رد کرد.",
            ["friend_accepted_invite"] = "✅ {0} دعوت شما را پذیرفت! برای شروع بازی روی «آماده» کلیک کنید.",
        ...
        ["de"] = new Dictionary<string, string>
        {
            ...
            ["draw"] = "🤝 Unentschieden!",
            ["your_result"] = "📊 <b>Dein Ergebnis:</b>",
            ["correct_answers"] = "✅ Richtig: {0}",
            ["time_spent"] = "⏱ Zeit: {0} Sek",
            ["opponent_result"] = "📊 <b>Gegner:</b> {0} {1}",
            ...
            ["friend_search"] = "🔍 Gib den @username deines Freundes ein (Beispiel: @ivan oder ivan):",
            ...
            ["opponent_in_game"] = "⚠️ Der Spieler kann deine Einladung jetzt nicht annehmen, er ist gerade in einem Spiel.",
            ...
            ["category_info"] = "\n📚 Kategorie: *{0}*",
            ["invite_accepted"] = "✅ Du hast die Einladung angenommen!",
            ["invite_declined"] = "❌ Du hast die Einladung abgelehnt.",
            ["invite_was_declined"] = "😔 {0} hat deine Einladung abgelehnt.",
            ["friend_accepted_invite"] = "✅ {0} hat deine Einladung angenommen! Klicke «Bereit» um das Spiel zu starten.",
        ...
        ["uz"] = new Dictionary<string, string>
        {
            ...
            ["correct"] = "✅ To'g'ri!",
            ["incorrect"] = "❌ Noto'g'ri!",
            ["your_answer"] = "Sizning javobingiz: *{0}*",
            ...
            ["draw"] = "🤝 Durrang!",
            ["your_result"] = "📊 <b>Sizning natijangiz:</b>",
            ["correct_answers"] = "✅ To'g'ri: {0}",
            ["time_spent"] = "⏱ Vaqt: {0} sek",
            ["opponent_result"] = "📊 <b>Raqib:</b> {0} {1}",
            ...
            ["friend_search"] = "🔍 Taklif qilish uchun do'stingizning @username kiriting (misol: @ivan yoki ivan):",
            ...
            ["opponent_in_game"] = "⚠️ O'yinchi hozir sizning taklifingizni qabul qila olmaydi, u hozirda o'yinda.",
            ...
            ["category_info"] = "\n📚 Kategoriya: *{0}*",
            ["invite_accepted"] = "✅ Siz taklifni qabul qildingiz!",
            ["invite_declined"] = "❌ Siz taklifni rad etdingiz.",
            ["invite_was_declined"] = "😔 {0} sizning taklifingizni rad etdi.",
            ["friend_accepted_invite"] = "✅ {0} sizning taklifingizni qabul qildi! O'yinni boshlash uchun «Tayyor» tugmasini bosing.",
        ...
        ["en"] = new Dictionary<string, string>
        {
            ...
            ["you_lost"] = "😔 You lost",
            ["draw"] = "🤝 Draw!",
            ["your_result"] = "📊 <b>Your result:</b>",
            ["correct_answers"] = "✅ Correct: {0}",
            ["time_spent"] = "⏱ Time: {0} sec",
            ["opponent_result"] = "📊 <b>Opponent:</b> {0} {1}",
            ...
            ["opponent_in_game"] = "⚠️ The player cannot accept your invitation right now, they are currently in a game.",
            ...
            ["category_info"] = "\n📚 Category: *{0}*",
            ["invite_accepted"] = "✅ You accepted the invitation!",
            ["invite_declined"] = "❌ You declined the invitation.",
            ["invite_was_declined"] = "😔 {0} declined your invitation.",
            ["friend_accepted_invite"] = "✅ {0} accepted your invitation! Click «Ready» to start the game.",
